$(["devtools/Workspace"], { 
	vars: {
		"#navigator favorites": [
			"Workspaces/veldapps.com/veldapps-workspaces/src/cavalion-blocks",
			"Workspaces/veldapps.com/veldapps-workspaces/src",
			"Workspaces/veldapps.com/veldapps-workspaces/src/vcl-comps",
			"Workspaces/veldapps.com/veldapps-workspaces/CHANGELOG.md;CHANGELOG.md;File"
		]
	},
	handlers: {
		loaded: function() {
